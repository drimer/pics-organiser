...
def test_report_imgs_where_path_date_not_in_exif_found_one_with_missing_only_day():
    ...
    assert result == [pictureManagerMock.find_images.return_value[1]]
...
def test_report_imgs_where_path_date_and_exif_are_different():
    ...
    assert result == [pictureManagerMock.find_images.return_value[1], pictureManagerMock.find_images.return_value[2]]